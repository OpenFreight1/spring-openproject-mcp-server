...
public class VersionTools {
  ...
  public Integer versionCreate(@NotNull Integer projectId,
      @JsonPropertyDescription("The version's name.") @NotNull String versionName,
    ...
    return openProjectApiClient.versionCreate(projectId, versionName, description, startDate,
        endDate);
  }
  ...
  public boolean versionUpdate(@NotNull Integer versionId,
      @JsonPropertyDescription("New name, or omit to leave unchanged.") @JsonProperty String versionName,
    ...
    return openProjectApiClient.versionUpdate(versionId, versionName, description, startDate,
        endDate);
  }
